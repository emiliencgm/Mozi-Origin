...
from mozi_ai_sdk.feihai_blue_ppo_v2.envs.env_feihai_blue_v2 import feihaiblue as Environment
...
os.environ['MOZIPATH'] = 'D:\\MOZI\\mozi-setup\\Mozi\\MoziServer\\bin'
FLAGS = flags.FLAGS
        ...
        for ep in range(1, total_test_episodes + 1):
            ...
            for t in range(1, max_ep_len + 1):
                ...
                if isinstance(state , tuple):
                    action = agent.select_action(state[0]) #TODO：state的类型，env.reset()的return
                else:
                    action = agent.select_action(state)
...
def train():
    ...
    try:
        ...
        # 可视化
        w = SummaryWriter('moziai-master-ppo-aircraft\\mozi_ai_sdk\\feihai_blue_ppo_v2\\PPO_reward')
        # training loop
        i = 1
        while time_step <= max_training_timesteps:
            ...
            for t in range(1, max_ep_len + 1):
                ...
                w.add_scalar(f"reward_{i}",current_ep_reward / t, t)
