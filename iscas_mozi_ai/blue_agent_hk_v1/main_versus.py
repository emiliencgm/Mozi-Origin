...
from blue_agent.env.env import Environment
from blue_agent.env import etc
from blue_agent.utils.bt_agent_antiship import CAgent
import argparse
import sys
import os
import traceback
...
def run(env, side_name=None):
    ...
    agent.my_act_tree(env, side_name, 0, "")
...
#     error_file = open(__file__.replace('main_versus.py',
