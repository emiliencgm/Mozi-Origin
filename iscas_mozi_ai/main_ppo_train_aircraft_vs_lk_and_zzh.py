...
from blue_agent_lj.feihai_blue_ppo_v4_train_aircraft_lk_and_zzh.envs.env_feihai_blue import feihaiblue as Environment_train_air_lk_and_zzh
# from blue_agent_lj.feihai_blue_ppo_test_v3.envs import etc
from blue_agent_lj.feihai_blue_ppo_v4_train_aircraft_lk_and_zzh.envs import etc_linux, etc
from blue_agent_lj.feihai_blue_ppo_v2_ship.PPO import PPO_ship
from blue_agent_lj.feihai_blue_ppo_v4_train_aircraft_lk_and_zzh.PPO import PPO
# from env import etc
#
...
def main(env):
    ...
    try:
        ...
        directory = "blue_agent_lj" + '/' + "feihai_blue_ppo_v4_train_aircraft_lk_and_zzh" + '/' + "PPO_preTrained" + '/' + env_name + '/'
        ...
        log_dir = "blue_agent_lj" + '/' + "feihai_blue_ppo_v4_train_aircraft_lk_and_zzh" + '/' + "PPO_logs"
...
if __name__ == "__main__":
    ...
    env = Environment_train_air_lk_and_zzh(etc.SERVER_IP, etc.SERVER_PORT, None, etc.DURATION_INTERVAL,
                                    etc.app_mode,
                                    etc.SYNCHRONOUS, etc.SIMULATE_COMPRESSION, etc.SCENARIO_NAME,
                                    platform_mode='开发')
