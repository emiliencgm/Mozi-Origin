...
class CScenario:
    ...
    def get_scenario_info(self):
        ...
        # 想定文件名
        "strScenFileName":self.strScenFileName ,
        # 描述
        "strDescription":self.strDescription, 
        # 当前时间
        "m_Time":self.m_Time ,
        # 是否是夏令时
        "bDaylightSavingTime":self.bDaylightSavingTime, 
        # 当前想定第一次启动的开始时间
        "m_FirstTimeRunDateTime":self.m_FirstTimeRunDateTime, 
        ...
        # 想定精细度
        "sMeta_Complexity":self.sMeta_Complexity,
        # 想定困难度
        "sMeta_Difficulty":self.sMeta_Difficulty, 
        # 想定发生地
        "strMeta_ScenSetting":self.strMeta_ScenSetting ,
        # 想定精细度的枚举类集合iSuspendCountDown
        "strDeclaredFeatures":self.strDeclaredFeatures ,
        # 想定的名称
        "strCustomFileName":self.strCustomFileName ,
        # 编辑模式剩余时间
        "iEditCountDown":self.iEditCountDown ,
        # 推演模式剩余时间
        "iStartCountDown":self.iStartCountDown, 
        # 暂停剩余时间
        "iSuspendCountDown":self.iSuspendCountDown ,
        # 获取推演的阶段模式
