...
from red_agent_lk_v1.utils_v1.tools import *
...
def update_patrol_zone(side_name, scenario):
    ...
    e2k_flag = False
    for contact in contacts.values():
        logging.info("对手名称：contact.strName = {}".format(contact.strName))
        if 'EC-130H' in contact.strName:
            lat1, lon1 = contact.dLatitude, contact.dLongitude
