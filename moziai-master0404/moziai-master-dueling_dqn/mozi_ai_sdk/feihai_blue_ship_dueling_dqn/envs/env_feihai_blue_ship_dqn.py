...
import random
import numpy as np
from mozi_ai_sdk.feihai_blue_ship_dueling_dqn.envs.utils import *
...
功能：打船的环境文件
'''
class feihaiblue_ship_dqn(BaseEnvironment):
    """
    作者：
    日期：
    功能：构造函数
    ...
    def reset(self):
        # 调用父类的重置函数
        super(feihaiblue_ship_dqn, self).reset()
    ...
    def execute_action(self, action):
        super(feihaiblue_ship_dqn, self).step()
