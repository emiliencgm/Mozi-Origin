...
import argparse
from mozi_ai_sdk.feihai_blue_mappo_aircraft.normalization import Normalization, RewardScaling
from mozi_ai_sdk.feihai_blue_mappo_aircraft.replay_buffer import ReplayBuffer
from mozi_ai_sdk.feihai_blue_mappo_aircraft.mappo_feihai_blue_aircraft import MAPPO_AIRCRAFT
from mozi_ai_sdk.feihai_blue_mappo_aircraft.envs.env_feihai_blue_mappo_aircraft import feihaiblue_mappo_aircraft as Environment_MAPPO_AIR
from mozi_ai_sdk.feihai_blue_mappo_aircraft.envs import etc
...
def create_env(args):
    env = Environment_MAPPO_AIR(etc.SERVER_IP, etc.SERVER_PORT, None, etc.DURATION_INTERVAL, etc.app_mode,
...
class Runner_MAPPO_MPE:
    def __init__(self, args, env, env_name, number, seed):
        self.args = args
        ...
        # Create env
        self.env = env  # Discrete action space
        ...
        self.args.action_dim_n = [9 for i in range(self.args.N)]
        ...
        # Create N agents
        self.agent_n = MAPPO_AIRCRAFT(self.args)
    ...
    def run_episode_mpe(self, evaluate=False):
        ...
        for episode_step in range(self.args.episode_limit):
            ...
            obs_next_n, r_n, done_n = self.env.execute_action(a_n)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--platform_mode", type=str, default='开发', help="Whether to use value clip.")

    args = parser.parse_args()
    env = create_env(args)
    runner = Runner_MAPPO_MPE(args, env, env_name="feihai_blue", number=1, seed=0)
    runner.run()
