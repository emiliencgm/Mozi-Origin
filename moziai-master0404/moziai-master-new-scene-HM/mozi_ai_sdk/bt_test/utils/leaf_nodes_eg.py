...
lst_1 = ['F-16A #7', 'F-16A #8', 'F-16A #9', 'F-16A #07', 'F-16A #08', 'F-16A #09','EC-130H #2']
# lst_2 = ['F-16A #5', 'F-16A #6', 'F-16A #7', 'F-16A #8', 'F-16A #9', 'EC-130H #1', 'E-2K #1']
lst_2 = ['F-16A #5', 'F-16A #6', 'F-16A #05', 'F-16A #06', 'EC-130H #1', 'E-2K #1']
...
def create_antisurfaceship_mission(side_name, scenario):
    ...
    if len(airs) <= 10:
        ...
        for k, v in target_1.items():
            ...
            way_point_dict_1_1['latitude'] = v.dLatitude+0.13
            way_point_dict_1_1['longitude'] = v.dLongitude-0.3
            way_point_list_1.append(way_point_dict_1_1)
            way_point_dict_1_2['latitude'] = v.dLatitude-0.18
            way_point_dict_1_2['longitude'] = v.dLongitude-0.1
            way_point_list_1.append(way_point_dict_1_2)
            way_point_dict_1_3['latitude'] = v.dLatitude+0.18
            way_point_dict_1_3['longitude'] = v.dLongitude+0.18
        ...
        # 航母坐标latitude='18.5375928742699', longitude='124.565600302125'
        # latitude = '18.6865660387061', longitude = '124.247406996066'
        # latitude = '18.3322898919935', longitude = '124.463396950868'
        # latitude = '18.4078411238085', longitude = '124.761834008778'
        # latitude = '18.8602537470917', longitude = '125.143172094355'
        # latitude = '19.0368888519603', longitude = '125.176109577935'
        for k, v in target_1.items():
            strkmssn_2.assign_unit_as_target(k)
            way_point_dict_2_1['latitude'] = v.dLatitude+0.15
            way_point_dict_2_1['longitude'] = v.dLongitude-0.32
            way_point_list_2.append(way_point_dict_2_1)
            way_point_dict_2_2['latitude'] = v.dLatitude-0.2
            way_point_dict_2_2['longitude'] = v.dLongitude-0.1
            way_point_list_2.append(way_point_dict_2_2)
            way_point_dict_2_3['latitude'] = v.dLatitude + 0.13
            way_point_dict_2_3['longitude'] = v.dLongitude + 0.2
        ...
        # latitude = '18.5505589918694', longitude = '124.102685995503'
        # latitude = '18.2575446920037', longitude = '124.367536128005'
        # latitude = '18.1579755900836', longitude = '125.028437439859'
        # 试试这组点
        wayPointList1 = [{'latitude': 18.5505589918694, 'longitude': 124.102685995503},
                         {'latitude': 18.2575446920037, 'longitude': 124.367536128005},
                         {'latitude': 18.1579755900836, 'longitude': 125.028437439859}]
...
def update_antisurfaceship_mission(side_name, scenario):
    ...
    if len(strkmssn) != 2:
        ...
        for air in airs_xl1.values():
            print('name=', air.strName, 'm_LoadoutGuid===', air.m_LoadoutGuid)
        return False
    ...
    if len(airs_fight) < 5 and len(strkmssn3) == 0:
        print('把巡逻2任务换成对舰打击')
        ...
        wayPointList3 = [pos,pos1,pos2]
        for item in wayPointList3:
            side.add_plan_way_point('strike3Way', item['longitude'], item['latitude'])
        strkmssn_3.add_plan_way_to_mission(0, 'strike3Way')
...
def edit_anti_ship_weapon_doctrine(doctrine):
    # AGM - 84L: 816
    doctrine.set_weapon_release_authority('816', '2999', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3101', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3102', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3103', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3000', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3104', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3105', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3106', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3107', '2', '1', '50', 'none', 'false')
    doctrine.set_weapon_release_authority('816', '3108', '2', '1', '50', 'none', 'false')
# 设置巡逻任务的油门、巡航的条例
...
def update_patrol_zone(side_name, scenario):
    ...
    point_2 = [(20.8612760556798,122.97096027272),(20.89954721661,123.18875736993),
               (20.7359032286196,122.92736887149),(20.7431007450093,123.145339607124)]
