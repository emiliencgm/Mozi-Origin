...
lst_1 = ['Udoshi #1', 'Udoshi #2', 'Udoshi #3', 'Udoshi #4', 'Udoshi #5', 'Udoshi #6', 'Udoshi #7', 'Udoshi #8',
         'Udoshi #9', 'Udoshi #10']
lst_4 = ['Champion #1', 'Champion #2', 'Champion #3', 'Champion #4', 'Champion #5', 'Champion #6', 'Champion #7', 'Champion #8']
# grj
lst_5 = ['Shrike #1']
lst_6 = ['Shrike #2']
# yjj
...
def create_patrol_mission(side_name, scenario):
    ...
    for point in point_list:
        ...
        patrolmssn.set_start_time('2022-10-8 13:10:00')
        # i += 1
    ...
    for point in point_list_ship:
        ...
        for name in point:
            point_str.append(name.strName)
        # 新建巡逻区名字
        patrol_name = side_name + 'fsmxl' + str(i)
...
def update_support_zone_1(side_name, scenario):
    ...
    point_2 = [(25.9451923372157, 124.241880351634), (25.9491888278148, 124.350646427266),
               (25.855061856555, 124.351306051816), (25.8684333305265, 124.234730648022)]
