...
from mozi_ai_sdk.feihai_blue_ppo_v2_ship.envs.env_feihai_blue_ship import feihaiblue_ship as Environment_ship
from mozi_ai_sdk.feihai_blue_ppo_v2.envs.env_feihai_blue import feihaiblue as Environment
from mozi_ai_sdk.feihai_blue_ppo_v2.envs.env_feihai_blue_all import feihaiblue_all as Environment_all
from mozi_ai_sdk.feihai_blue_ppo_v2_ship.envs import etc_ship
from mozi_ai_sdk.feihai_blue_ppo_v2.envs import etc
...
def create_env():
    ...
    print('开发模式')
    env = Environment_all(etc.SERVER_IP, etc.SERVER_PORT, None, etc.DURATION_INTERVAL, etc.app_mode,
...
def evaluate():
    ...
    try:
        ...
        directory = "feihai_blue_ppo_v2" + '/' + "PPO_preTrained" + '/' + env_name + '/'
        checkpoint_path = directory + "PPO_{}_{}_{}.pth".format(env_name, random_seed, run_num_pretrained)
        print("loading network from : " + checkpoint_path)

        agent.load(checkpoint_path)

        directory_ship = "feihai_blue_ppo_v2_ship" + '/' + "PPO_preTrained" + '/' + env_name + '/'
